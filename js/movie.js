...
function expand(x){
	...
	// 				if (b == marvelarr[i].Title) {
	// 					a.innerHTML = javaobj[i].Title;//${Tempalte(marvelarr[i])}
	// 				}	
	// 			}
	// 		}
	// 		catch(e){
	...
	// 	}
	// }
	// xhttp.open("GET", "http://../json/marvel.json");
	// xhttp.send();